...
#=============================================================================
# Target rules for targets named ComputeShaderDemo

# Build rule for target.
ComputeShaderDemo: cmake_check_build_system
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 ComputeShaderDemo
.PHONY : ComputeShaderDemo

# fast build rule for target.
ComputeShaderDemo/fast:
